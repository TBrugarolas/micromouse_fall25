...
class Distance():
    ...
    def scan(self):
        self.ir.scan()
        self.la = self.la_a * self.ir.lir_a + self.la_b
        self.lb = self.lb_a * self.ir.lir_b + self.lb_b
        self.ca = self.ca_a * self.ir.cir_a + self.ca_b
        self.cb = self.cb_a * self.ir.cir_b + self.cb_b
        self.ra = self.ra_a * self.ir.rir_a + self.ra_b
        self.rb = self.rb_a * self.ir.rir_b + self.rb_b
